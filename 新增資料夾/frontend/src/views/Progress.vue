...
const accuracyData = computed(() => {
  ...
  return [
    { value: progress.value.english_progress.accuracy_rate, name: 'English' },
    { value: progress.value.japanese_progress.accuracy_rate, name: 'Japanese' }
  ]
})

const streak = ref(5) // Demo data - replace with real API data

// Demo Knowledge Graph Data - replace with real API data
const knowledgeData = {
  nodes: [
