...
This document describes the current storage, API, and integration boundaries for the additive Learning Session foundation that ships in `1.6.0`.
...
Focused backend/frontend, E2E, Docker validation, and delivery gates are green for `1.6.0` on the mandated Python `3.11.x`, Node.js `22.18.0`, and npm `10.9.3` toolchain.
