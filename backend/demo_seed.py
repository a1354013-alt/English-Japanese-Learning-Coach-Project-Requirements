...
def _clear_database(db: Database, user_id: str) -> None:
    ...
    db.learning_session_repository.clear_local_demo_user_session_data(user_id=user_id)
    db.reset_learning_goals_for_demo_user(user_id=user_id)
    tables = [
